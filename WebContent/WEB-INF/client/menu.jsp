<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/e-banque/client/index">Gestion de Compte Bancaire</a>
		</div>
		<div class="navbar-collapse collapse">
       	<ul class="nav navbar-nav">
			<li class="active"> <a href="/e-banque/client/index"><span class="glyphicon glyphicon-home"></span> Home  </a> </li>
			<li class="active"> <a href="#">Crediter un compte  </a> </li>
			<li class="active"> <a href="#"> Debiter un compte </a> </li>
